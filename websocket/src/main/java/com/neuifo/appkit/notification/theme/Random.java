...
public class Random extends HoloDark {
    ...
    public Random(ViewStub stub) {
        super(stub);
        stub.setLayoutResource(R.layout.im_activity_read_inner_holo);
    }
    ...
    public void init(LinearLayout layout) {
        ...
        if (brightness > 130) {
            ...
            ((TextView)linearLayout.findViewById(R.id.im_notification_title)).setTextColor(Color.BLACK);
            ((TextView)linearLayout.findViewById(R.id.im_notification_subtitle)).setTextColor(Color.BLACK);
        }
        else {
            subTheme = new HoloDark();
            ((TextView)linearLayout.findViewById(R.id.im_notification_title)).setTextColor(Color.WHITE);
            ((TextView)linearLayout.findViewById(R.id.im_notification_subtitle)).setTextColor(Color.WHITE);
        }
    }
